...
def find_department_by_id():
    ...
    print(department) if department else print('fDepartment {id_} not found')
...
def create_employee():
    name = input("Enter the department's name: ")
    job_title = input("Enter the department's job_title: ")
    department_id = input("Enter the department's department_id: ")
    try:
...
def update_employee():
    id_ = input("Enter the emplyee's id: ")
    if employee := Employee.find_by_id(id_):
        try:
            name = input("Enter the Employee's new name: ")
            employee.name = name
            job_title = input("Enter the department's new job_title: ")
            employee.job_title = job_title
            department_id = input("Enter the department's new department_id: ")
